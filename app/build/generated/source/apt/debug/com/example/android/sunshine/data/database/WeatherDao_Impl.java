...
public class WeatherDao_Impl implements WeatherDao {
  ...
  @Override
  public void bulkInsert(WeatherEntry... weatherEntries) {
    __db.beginTransaction();
    try {
      __insertionAdapterOfWeatherEntry.insert(weatherEntries);
  ...
  @Override
  public LiveData<List<WeatherEntry>> getWeatherSinceDate(Date date) {
    final String _sql = "SELECT * FROM weather WHERE date >= ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    final Long _tmp;
