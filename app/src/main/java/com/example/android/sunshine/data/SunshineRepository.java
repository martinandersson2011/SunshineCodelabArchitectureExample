...
public class SunshineRepository {
    ...
    public synchronized static SunshineRepository getInstance(WeatherDao weatherDao, WeatherNetworkDataSource weatherNetworkDataSource, AppExecutors executors) {
    ...
    public LiveData<List<WeatherEntry>> getWeatherList() {
        ...
        return mWeatherDao.getWeatherSinceDate(date);
    }
